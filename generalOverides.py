def fixOutput(response):
  ...
  if first_line == "Please try again with a more appropriate inputs.":
    return "..."
  elif first_line == "" or first_line == None or first_line[0:1] == "??" or first_line[0:1] == "--" or first_line[0:1] == "__" or first_line[0:1] == "!!" or first_line[0:1] == "**": return response #return whole response if weird response
